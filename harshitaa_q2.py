...
#
#     # Initialize a dictionary to count permutations of real names in allNames
#     name_counts = {name: 0 for name in realNames}
#
#     # Iterate through allNames to count permutations of real names
#     for name in allNames:
#         for real_name in realNames:
#             if sorted(name) == sorted(real_name):
